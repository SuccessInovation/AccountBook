...
const profitImage = computed(() => {
  ...
  if (rate < 40) {
    return new URL('@/img/logo1.png', import.meta.url).href // 초록 배추
  } else if (rate < 80) {
    return new URL('@/img/logo4.jpg', import.meta.url).href // 초록 배추 다음 살짝 노랑
  } else if (rate < 100) {
    return new URL('@/img/logo3.png', import.meta.url).href // 좀 빨개진 배추
  } else {
    return new URL('@/img/logo2.png', import.meta.url).href // 빨간 배추
  }
})
